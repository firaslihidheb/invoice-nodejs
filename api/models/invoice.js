...
class Invoice {
    ...
    addInvoice(req, res) {
        try {
            ...
            connectionPool.query(`INSERT INTO invoice (${columnList.join(', ')}) VALUES 
                ...
                if (error) {
                    ...
                    connectionPool.query(`INSERT INTO invoice_product (invoice_id,product_id,quantity,rate) VALUES 
    ...
    getInvoice(req, res) {
        try {
            ...
            connectionPool.query(`SELECT inv.*, ip.*, pr.name product_name, cst.name customer_name, cst.email customer_email, cst.company_name customer_company_name, usr.mobile user_mobile,usr.email user_email,usr.name user_name,usr.company_name user_company_name,usr.company_address user_company_address
                                  FROM invoice inv, invoice_product ip, product pr, customer cst, user usr
